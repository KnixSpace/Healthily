...
public class FindDoctor {
    public List<String> getDoctorBySpecialiazation(String description){
        ...
        Map<String, String> doctorSpecializationMap = new HashMap<>();
        doctorSpecializationMap.put("General", String.valueOf(Arrays.asList(
        ...
        doctorSpecializationMap.put("Pediatrician", String.valueOf(Arrays.asList(
        ...
        doctorSpecializationMap.put("Cardiologist", String.valueOf(Arrays.asList(
        ...
        doctorSpecializationMap.put("Dermatologist", String.valueOf(Arrays.asList(
        ...
        doctorSpecializationMap.put("Psychiatrist", String.valueOf(Arrays.asList(
        ...
        doctorSpecializationMap.put("Ophthalmologist", String.valueOf(Arrays.asList(
        ...
        doctorSpecializationMap.put("Gynecologist", String.valueOf(Arrays.asList(
        ...
        doctorSpecializationMap.put("Endocrinologist", String.valueOf(Arrays.asList(
                "hormonal disorders", "diabetes", "thyroid disorders",
                "adrenal disorders", "hormone therapy"
        )));

        doctorSpecializationMap.put("Gastroenterologist", String.valueOf(Arrays.asList(
                "digestive health", "gastrointestinal disorders", "crohn's disease",
                "ulcerative colitis", "endoscopy", "colonoscopy"
        )));


        doctorSpecializationMap.put("Otolaryngologies", String.valueOf(Arrays.asList(
        ...
        doctorSpecializationMap.put("Neurologist", String.valueOf(Arrays.asList(
